...
FORM SET_FIELDCAT.
  ...
  GS_FCAT-COLTEXT    = TEXT-F25. "'STATUS'.
  GS_FCAT-JUST       = 'C'.
  GS_FCAT-OUTPUTLEN  = '4'.
  ...
  GS_FCAT-COLTEXT    = TEXT-F26. "'Message'.
  GS_FCAT-FIX_COLUMN = 'X'.
  GS_FCAT-EMPHASIZE  = 'C410'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
...
*  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
    ...
    GS_FCAT-FIELDNAME  = 'KUNNR_WL'.
    GS_FCAT-REF_FIELD  = 'LIFNR'.
    GS_FCAT-REF_TABLE  = 'LFM1'.
    GS_FCAT-COLTEXT    = TEXT-F20.
    GS_FCAT-EMPHASIZE  = 'C700'.
    GS_FCAT-OUTPUTLEN  = '4'.
    APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

    GS_FCAT-FIELDNAME  = 'KUNNR_WL_TXT'.
    GS_FCAT-COLTEXT    = TEXT-F21.
    GS_FCAT-EMPHASIZE  = 'C700'.
    APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

    GS_FCAT-FIELDNAME  = 'ZKMEIN_MM'.
  ...
  ELSE.
    ...
    GS_FCAT-FIELDNAME  = 'ZKMEIN_SO'.
    GS_FCAT-COLTEXT    = TEXT-F30.
    GS_FCAT-EMPHASIZE  = 'C500'.
    APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

    GS_FCAT-FIELDNAME  = 'ZKBETR_SO'.
    GS_FCAT-COLTEXT    = TEXT-F31.
    GS_FCAT-CFIELDNAME = 'ZKONWA_MM'.
    GS_FCAT-EMPHASIZE  = 'C300'.
    APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

    GS_FCAT-FIELDNAME  = 'ZKONWA_SO'.
