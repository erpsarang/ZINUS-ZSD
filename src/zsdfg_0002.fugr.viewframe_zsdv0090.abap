*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDV0090
*   generation date: 2020.11.10 at 16:56:42
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDV0090            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDV0090'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDV0090_EXTRACT
TOTAL = ZSDV0090_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDV0090'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDV0090-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDV0090_EXTRACT
TOTAL = ZSDV0090_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDV0090-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDV0090'
...
TOTAL = ZSDV0090_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDV0090-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDV0090-UPD_FLAG NE SPACE.
