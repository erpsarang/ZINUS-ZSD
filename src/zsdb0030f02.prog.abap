...
FORM SET_FIELDCAT.
  ...
  GS_FCAT-COLTEXT    = TEXT-F08. "'STATUS'.
  GS_FCAT-JUST       = 'C'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'KUNNR'.
  GS_FCAT-COLTEXT    = TEXT-F01. "'CUSTOMER'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'VKORG'.
  GS_FCAT-COLTEXT    = TEXT-F02. "'Sales Org..
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'VTWEG'.
  GS_FCAT-COLTEXT    = TEXT-F03. "'Distribution Channel'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'MATNR'.
  GS_FCAT-COLTEXT    = TEXT-F04. "'MATERIAL(SKU)'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'KDMAT'.
  GS_FCAT-COLTEXT    = TEXT-F05. "'CUSTOMER MATERIAL'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

** Not use HQ 2020.10.26 - Start
*  GS_FCAT-FIELDNAME  = 'CLASS'.
*  GS_FCAT-COLTEXT    = TEXT-F06. "'CLASS'.
*  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
*
*  GS_FCAT-FIELDNAME  = 'MWERT'.
*  GS_FCAT-COLTEXT    = TEXT-F07. "'Characteristic Value'.
*  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
** Not use HQ 2020.10.26 - End

  GS_FCAT-FIELDNAME  = 'MESSAGE'.
  GS_FCAT-COLTEXT    = TEXT-F09. "'Message'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
