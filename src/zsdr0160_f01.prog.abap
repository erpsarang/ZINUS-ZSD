...
*   " Origin PO# Item No  유통채널 10인 경우만 필수
    IF GT_DISP-VTWEG EQ '10'.
      PERFORM REQUIRED_FIELD_CHECK USING : GT_DISP-POSEX_E TEXT-F17. "Origin PO# Item No
    ENDIF.
...
*                ' '    'CFIELDNAME'   'WAERK',
                ...
                ' '    'REF_TABLE'    'VBKD',
                ' '    'REF_FIELD'    'IHREZ',
                'E'    'COLTEXT'      TEXT-A31,  " ZINUS USA PO#

                'S'    'FIELDNAME'    'BSTKD',
                ' '    'REF_TABLE'    'VBKD',
                ' '    'REF_FIELD'    'BSTKD',
                'E'    'COLTEXT'      TEXT-A32,  " HQ PO#
...
*                'E'    'COLTEXT'      TEXT-A17,  " QTY
                ...
                ' '    'REF_TABLE'    'VBKD',
                ' '    'REF_FIELD'    'POSEX_E',
                'E'    'COLTEXT'      TEXT-A54,  " Origin PO# Item No

                'S'    'FIELDNAME'    'ZZISAID',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZISAID',
                'E'    'COLTEXT'      TEXT-A41,  " ISA-ID

                'S'    'FIELDNAME'    'ZZINTVN',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZINTVN',
                'E'    'COLTEXT'      TEXT-A42,  " Internal Vendor Number

                'S'    'FIELDNAME'    'ZZSCAC',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSCAC',
                'E'    'COLTEXT'      TEXT-A43,  " SCAC

                'S'    'FIELDNAME'    'ZZINTCN',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZINTCN',
                'E'    'COLTEXT'      TEXT-A44,  " Internal Control Number

                'S'    'FIELDNAME'    'ZZSHRO',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSHRO',
                'E'    'COLTEXT'      TEXT-A45,  " SHP ROUTING

                'S'    'FIELDNAME'    'ZZSHLE',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSHLE',
                'E'    'COLTEXT'      TEXT-A46,  " SHP SVC LEVEL

                'S'    'FIELDNAME'    'ZZSSNO',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSSNO',
                'E'    'COLTEXT'      TEXT-A47,  " SHP SEAL NUM

                'S'    'FIELDNAME'    'ZZVENDID',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZVENDID',
                'E'    'COLTEXT'      TEXT-A48,  " CUST VENDOR ID

                'S'    'FIELDNAME'    'ZZWHCODE',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZWHCODE',
                'E'    'COLTEXT'      TEXT-A49,  " WH CODE

                'S'    'FIELDNAME'    'ZZSRDFR',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSRDFR',
                'E'    'COLTEXT'      TEXT-A50,  " Expected date

                'S'    'FIELDNAME'    'ZZSRDTO',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSRDTO',
                'E'    'COLTEXT'      TEXT-A51,  " Delivery by Date

                'S'    'FIELDNAME'    'ZZSVCAT',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSVCAT',
                'E'    'COLTEXT'      TEXT-A52,  " Service catalog

                'S'    'FIELDNAME'    'ZZSCACC',
                ' '    'REF_TABLE'    'VBAK',
                ' '    'REF_FIELD'    'ZZSCACC',
                'E'    'COLTEXT'      TEXT-A53,  " SCAC Code
...
*                'E'    'COLTEXT'      TEXT-A20,  " Message
                ...
                ' '    'REF_FIELD'    'VBELN',
                ' '    'STYLE'        '00000200',
                'E'    'COLTEXT'      TEXT-A19,  " Order No.

                'S'    'FIELDNAME'    'POSNR',
                ' '    'REF_TABLE'    'VBAP',
                ' '    'REF_FIELD'    'POSNR',
                ' '    'STYLE'        '00000200',
                'E'    'COLTEXT'      TEXT-A22,  " Order Item No.
...
FORM SET_HEADER_DATA  TABLES PT_PART STRUCTURE BAPIPARNR
                             PT_EXTENSIONIN STRUCTURE BAPIPAREX
...
*  ENDIF.
  PS_HEAD-DOC_TYPE = GT_HEAD-AUART.     "Order Type
...
*  PS_HEAD-ORD_REASON = GT_HEAD-AUGRU.
  ...
  PS_HEAD-PURCH_NO_C = GT_HEAD-BSTKD.   "HQ PO#
  PS_HEADX-PURCH_NO_C = C_X.
  PS_HEAD-PURCH_NO_S = GT_HEAD-BSTKD_E. "Origin PO# Customer PO #
  PS_HEADX-PURCH_NO_S = C_X.
  PS_HEAD-REF_1 = GT_HEAD-IHREZ.        "ZINUS USA PO#
  PS_HEADX-REF_1 = C_X.


  PS_HEAD-QT_VALID_T = GT_HEAD-VDATU.   "Valid to <= 납품 요청일 RDD
...
*  " Extension
*   PT_EXTENSIONIN-ITM_NUMBER = LV_POSNR.
  CLEAR LS_BAPE_VBAK-VBELN.
*  "VBAK
  " EDI ASN
  LS_BAPE_VBAK-ZZISAID    = GT_HEAD-ZZISAID  .  "ISA-ID
  LS_BAPE_VBAK-ZZINTVN    = GT_HEAD-ZZINTVN  .  "Internal Vendor Number
  LS_BAPE_VBAK-ZZSCAC     = GT_HEAD-ZZSCAC   .  "SCAC
  LS_BAPE_VBAK-ZZINTCN    = GT_HEAD-ZZINTCN  .  "Internal Control Number
  LS_BAPE_VBAK-ZZSHRO     = GT_HEAD-ZZSHRO   .  "SHP ROUTING
  LS_BAPE_VBAK-ZZSHLE     = GT_HEAD-ZZSHLE   .  "SHP SVC LEVEL
  LS_BAPE_VBAK-ZZSSNO     = GT_HEAD-ZZSSNO   .  "SHP SEAL NUM
  LS_BAPE_VBAK-ZZVENDID   = GT_HEAD-ZZVENDID .  "CUST VENDOR ID
  LS_BAPE_VBAK-ZZWHCODE   = GT_HEAD-ZZWHCODE .  "WH CODE
  LS_BAPE_VBAK-ZZSRDFR    = GT_HEAD-ZZSRDFR  .  "Expected date
  LS_BAPE_VBAK-ZZSRDTO    = GT_HEAD-ZZSRDTO  .  "Delivery by Date
  LS_BAPE_VBAK-ZZSVCAT    = GT_HEAD-ZZSVCAT  .  "Service catalog
  LS_BAPE_VBAK-ZZSCACC    = GT_HEAD-ZZSCACC  .  "SCAC Code

  MOVE 'BAPE_VBAK' TO PT_EXTENSIONIN-STRUCTURE.
   CALL METHOD CL_ABAP_CONTAINER_UTILITIES=>FILL_CONTAINER_C
     EXPORTING
       IM_VALUE               = LS_BAPE_VBAK
     IMPORTING
       EX_CONTAINER           = PT_EXTENSIONIN+30
     EXCEPTIONS
       ILLEGAL_PARAMETER_TYPE = 1
       OTHERS                 = 2.
  APPEND : PT_EXTENSIONIN. CLEAR : PT_EXTENSIONIN.


*"VBAKX
" EDI ASN
  LS_BAPE_VBAKX-ZZISAID  = 'X'. "ISA-ID
  LS_BAPE_VBAKX-ZZINTVN  = 'X'. "Internal Vendor Number
  LS_BAPE_VBAKX-ZZSCAC   = 'X'. "SCAC
  LS_BAPE_VBAKX-ZZINTCN  = 'X'. "Internal Control Number
  LS_BAPE_VBAKX-ZZSHRO   = 'X'. "SHP ROUTING
  LS_BAPE_VBAKX-ZZSHLE   = 'X'. "SHP SVC LEVEL
  LS_BAPE_VBAKX-ZZSSNO   = 'X'. "SHP SEAL NUM
  LS_BAPE_VBAKX-ZZVENDID = 'X'. "CUST VENDOR ID
  LS_BAPE_VBAKX-ZZWHCODE = 'X'. "WH CODE
  LS_BAPE_VBAKX-ZZSRDFR  = 'X'. "Expected date
  LS_BAPE_VBAKX-ZZSRDTO  = 'X'. "Delivery by Date
  LS_BAPE_VBAKX-ZZSVCAT  = 'X'. "Service catalog
  LS_BAPE_VBAKX-ZZSCACC  = 'X'. "SCAC Code

  MOVE 'BAPE_VBAKX' TO PT_EXTENSIONIN-STRUCTURE.
  CALL METHOD CL_ABAP_CONTAINER_UTILITIES=>FILL_CONTAINER_C
    EXPORTING
      IM_VALUE               = LS_BAPE_VBAKX
    IMPORTING
      EX_CONTAINER           = PT_EXTENSIONIN+30
    EXCEPTIONS
      ILLEGAL_PARAMETER_TYPE = 1
...
*                             PT_CONDX STRUCTURE BAPICONDX.
  ...
  LOOP AT GT_DISP WHERE BSTKD = GT_HEAD-BSTKD.
    ...
    PT_ITEM-CUST_MAT35 = GT_DISP-KDMAT.     "customer SKU
    PT_ITEMX-CUST_MAT35 = C_X.

    PT_ITEM-POITM_NO_S = GT_DISP-POSEX_E.   "Origin PO# Item No
    PT_ITEMX-POITM_NO_S = C_X.

*   " Purchase order item
    PT_ITEM-PO_ITM_NO = LV_POSNR.           "Item Number of the Underlying Purchase Order
    PT_ITEMX-PO_ITM_NO = C_X.
...
* header difference check
  ...
  SORT LT_DISP BY BSTKD AUART VKORG VTWEG SPART
                  KUNNR KUNNR1 KUNNRO IHREZ BSTKD VDATU
                  ZZISAID ZZINTVN ZZSCAC ZZINTCN ZZSHRO ZZSHLE ZZSSNO
                  ZZVENDID ZZWHCODE ZZSRDFR ZZSRDTO ZZSVCAT ZZSCACC
                  .
  DELETE ADJACENT DUPLICATES FROM LT_DISP
    COMPARING BSTKD AUART VKORG VTWEG SPART
                  ...
                  .
  LOOP AT LT_DISP.
    LT_DUP-BSTKD_E = LT_DISP-BSTKD_E. "BSTKD
    LT_DUP-CNT = 1. COLLECT LT_DUP. CLEAR LT_DUP.
  ENDLOOP.
  DELETE LT_DUP WHERE CNT = 1.
  LOOP AT LT_DUP.
    LOOP AT GT_DISP WHERE BSTKD_E = LT_DUP-BSTKD_E.
      CHECK GT_DISP-ICON1 IS INITIAL.
...
*  IF GT_DISP-MATNR  IS INITIAL. GT_DISP-MATNR = GS_DISP-MATNR. ENDIF.
  ...
  IF GT_DISP-ZZISAID  IS INITIAL. GT_DISP-ZZISAID  = GS_DISP-ZZISAID . ENDIF.
  IF GT_DISP-ZZINTVN  IS INITIAL. GT_DISP-ZZINTVN  = GS_DISP-ZZINTVN . ENDIF.
  IF GT_DISP-ZZSCAC   IS INITIAL. GT_DISP-ZZSCAC   = GS_DISP-ZZSCAC  . ENDIF.
  IF GT_DISP-ZZINTCN  IS INITIAL. GT_DISP-ZZINTCN  = GS_DISP-ZZINTCN . ENDIF.
  IF GT_DISP-ZZSHRO   IS INITIAL. GT_DISP-ZZSHRO   = GS_DISP-ZZSHRO  . ENDIF.
  IF GT_DISP-ZZSHLE   IS INITIAL. GT_DISP-ZZSHLE   = GS_DISP-ZZSHLE  . ENDIF.
  IF GT_DISP-ZZSSNO   IS INITIAL. GT_DISP-ZZSSNO   = GS_DISP-ZZSSNO  . ENDIF.
  IF GT_DISP-ZZVENDID IS INITIAL. GT_DISP-ZZVENDID = GS_DISP-ZZVENDID. ENDIF.
  IF GT_DISP-ZZWHCODE IS INITIAL. GT_DISP-ZZWHCODE = GS_DISP-ZZWHCODE. ENDIF.
  IF GT_DISP-ZZSRDFR  IS INITIAL. GT_DISP-ZZSRDFR  = GS_DISP-ZZSRDFR . ENDIF.
  IF GT_DISP-ZZSRDTO  IS INITIAL. GT_DISP-ZZSRDTO  = GS_DISP-ZZSRDTO . ENDIF.
  IF GT_DISP-ZZSVCAT  IS INITIAL. GT_DISP-ZZSVCAT  = GS_DISP-ZZSVCAT . ENDIF.
  IF GT_DISP-ZZSCACC  IS INITIAL. GT_DISP-ZZSCACC  = GS_DISP-ZZSCACC . ENDIF.
