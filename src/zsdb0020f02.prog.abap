...
FORM SET_FIELDCAT.
  ...
  GS_FCAT-COLTEXT    = TEXT-F02. "'Material'.
  GS_FCAT-FIX_COLUMN = 'X'.
  GS_FCAT-EMPHASIZE =  'X'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'WERKS '.
  GS_FCAT-COLTEXT    = TEXT-F07. "PLANT'.
  GS_FCAT-FIX_COLUMN = 'X'.
  GS_FCAT-EMPHASIZE =  'X'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'IDNRK '.
  GS_FCAT-COLTEXT    = TEXT-F03. "'BOM component'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'BMENG '.
  GS_FCAT-COLTEXT    = TEXT-F04. "'Base quantity'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'MENGE '.
  GS_FCAT-COLTEXT    = TEXT-F05. "'Component quantity'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.

  GS_FCAT-FIELDNAME  = 'MESSAGE'.
  GS_FCAT-COLTEXT    = TEXT-F06. "'Message'.
  APPEND GS_FCAT TO GT_FCAT. CLEAR: GS_FCAT.
